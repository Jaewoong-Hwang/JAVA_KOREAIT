...
public class C04BitArith {
	public static void main(String[] args) {
		...
		//------------------------------------------------------------ &연산은 1이 ture 그러므로, num1 과 num2을 비교해서 둘다 1이면 1로 출력하는 것
		int num4 = num1|num2;	//00000000 00000000 0000000 00011111 = 31
		int num5 = num1^num2;	//00000000 00000000 0000000 00011011 = 27  =========둘다 1이면 0
		int num6 = ~num1;		//11111111 11111111 1111111 11110000 =     ============비트를 반전 -16 
