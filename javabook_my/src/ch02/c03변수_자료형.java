...
public class c03변수_자료형 {
	...
	public static void main(String[] args) {
		...
		//lv(공간) = rv(깂)  rv를 먼저 처리(저장 or 연산) 한 다음 lv에 대입
		
		int num1; // 4byte 정수 공간 형성 + num1 이름부여 (변수 정의)
		num1 = 10; // 10리터럴 상수값 상수 pool 에 저장, num1공간에 값 대입(복사)
		int num2 = 4; // 4 리터럴 상수값 상수 pool 에 저장, 4byte 정수 곤강 num2에 초기값으로 대입
						//		num2에 4로 초기화
