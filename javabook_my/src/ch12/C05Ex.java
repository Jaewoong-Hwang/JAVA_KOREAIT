...
class Parttimer extends Employee {
	...
	public String toString() {
		return "Parttimer [hour_pay=" + hour_pay + ", name=" + name + ", addr="+ getAddr() + ", age="+ getAge() +"]";
	}
...
class Regular extends Employee {
	...
	@Override
	public String toString() {
		return "Regular [salary=" + salary + ", name=" + name + ", addr=" + getAddr() + ", age="+getAge()+"]";
	}
